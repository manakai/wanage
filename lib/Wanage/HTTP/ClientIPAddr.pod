...
The list contains the C<CF-Connecting-IP:> address, if any, followed
by any C<X-Forwarded-For:> addresses, followed by the C<REMOTE_ADDR>
...
By default, the C<select_addr> method return the first address in the
list.

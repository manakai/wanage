...
the C<X-Forwarded-Scheme:> or C<X-Forwarded-Proto:> header, if any, is
used to determine the scheme component of the URL.
...
SuikaWiki:CGI <http://suika.suikawiki.org/~wakaba/wiki/sw/n/CGI>.

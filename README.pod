...
These modules require Perl 5.10 or later.  In addition, a few non-core
modules are required: L<Exporter::Lite>; L<Path::Class>; L<List::Ish>
(in the C<modules/perl-ooutils> submodule); L<Web::Encoding> and other
modules from the <https://github.com/manakai/perl-web-url>
repository); L<Web::URL> and other modules from the
<https://github.com/manakai/perl-web-encodings> repository).

It also requires a promise implementation (e.g. L<Promise> from the
<https://github.com/manakai/perl-promise> repository) if you would
like to use promise-related features.

Optional modules such as C<Warabe::App::Role::*> might require
additional modules; see relevant documentations and source codes of
those modules.
